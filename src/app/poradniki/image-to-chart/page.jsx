        ...
        <MathJaxContext>
            <main>
                ...
                <div className={`image-overlay ${isImageOpen ? 'open' : ''}`} onClick={handleOverlayClick}>
                    <Image src="/img-to-chart-1.png" alt="Article Cover" layout="responsive" width={700} height={475} className="image-fullscreen" />
                </div>
                <div className="page" id="how-it-works">
                    <div className="content-container">
                        <div className="article">
                            <div className="article-cover-container" onClick={handleImageClick}>
                                <Image src="/img-to-chart-1.png" alt="Article Cover" layout="responsive" width={700} height={475} className="article-cover" />
