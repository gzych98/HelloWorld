...
export default function Admin() {
  ...
  useEffect(() => {
    const storedPassword = "WyB!o#T#kq@-";
        ...
        <div className='admin'>
          ...
          <div className="admin-page">
            <h1 onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
              <a href="http://www.jerzyplesniarowicz.pl" target="_blank" rel="noopener noreferrer">www.jerzyplesniarowicz.pl</a>
            </h1>
            {isPreviewVisible && (
              <div className="site-preview">
                <iframe src="http://www.jerzyplesniarowicz.pl" title="Podgląd strony" />
              </div>
            )}
            {sections.map(section => (
